...
// 1. ROUTE INTO ROOM (FIXED: Low-latency FileReader Binary Buffer Array to bypass Vercel locks)
document.getElementById('btn-enter-flix').addEventListener('click', () => {
    ...
    if (filePicker.files && filePicker.files.length > 0) {
        ...
        // Formats data chunks dynamically into a memory-safe asset stream block
        ...
        alert("Please select an offline media file or insert a video link first!");
    }
});
...
btnToggle3D.addEventListener('click', () => {
    ...
    if (is3DMode) {
        ...
        // Dynamically kickstart the graphics pipeline calculation layers safely *only* on call
